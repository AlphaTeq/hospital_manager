## Backend for Hospital Manager

Admin (http://127.0.0.1:8000/hospital_admin/)
Setup departments:
> Hospitals > Add hospital (select a hospital) > Edit hospital > Add departments

Doctor registers, sets up profile
Register in a hospital & department:
> Multiple Hospital > Explore > register (select department & specialization, add certificate)

Admin
Register doctor:
> Doctors > Pending > Accept

Patient
Book appointment:
> Multiple Hospital > Explore > Departments & Doc list  > (Select doc) Book appointment
